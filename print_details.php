    ...
    <div class="row w-100 flex-grow-1">
       ...
       <nav class="col-md-3 col-lg-2 bg-secondary text-white p-3">
        ...
        <div class="col-md-9 col-lg-10 text-center" id="content-area">
            <h4 class="mt-4">Select a Course to Print Finalized Marks</h4>
            <?php if (count($courses) > 0): ?>
                <div class="d-flex flex-wrap justify-content-center mt-4">
                    <?php foreach ($courses as $course): ?>
                        <!-- Added target="_blank" so PDF opens in new tab -->
                        <form action="print_action.php" method="get" target="_blank" style="display:inline;">
